...
class CALMoriController
{
	...
	public function intervalHS($start,$finish)
    {
		...
		$result = $this->CALMori->getAdapter()->query("select start_date_time as time, measured_uncorrected from CALM_ori where start_date_time between '".$start."' and '".$finish."';")->execute();
